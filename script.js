...
const diaryResponses = [
  ...
  "С Днём Рождения, прекрасная душа.",
  "Ты храбрее, чем думаешь, сильнее, чем кажешься, и ты важна, даже если думаешь обратное",
  "Некоторой магии нельзя научить. Она живёт в твоей улыбке, в твоих снах, ярких эмоциях и заразительном смехе",
  "Тебе не нужна волшебная палочка, чтобы быть волшебной. Ты уже такая. \np.s. но если все таки волшебная палочка нужна, ты знаешь где ее найти:)))",
